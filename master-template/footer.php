		  ...
		  <div class="modal-body p-30 bg-white">
            ...
            <div>
                <div class="d-flex flex-row">
                    <div class=""><img  src="template/template/vertical/../../images/avatar/avatar-13.png" alt="user" class="rounded bg-danger-light w-150" width="100"></div>
                    <div class="ps-20">
          ...
          <div class="media-list media-list-hover mt-20">
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-success" href="#">
				<img  src="template/template/vertical/../../images/avatar/1.jpg" alt="...">
			  </a>
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-danger" href="#">
				<img  src="template/template/vertical/../../images/avatar/2.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="fs-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-warning" href="#">
				<img  src="template/template/vertical/../../images/avatar/3.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="fs-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-primary" href="#">
				<img  src="template/template/vertical/../../images/avatar/4.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="fs-16">
				  <a class="hover-primary" href="#"><strong>Evan</strong></a>
                ...
                <div class="chat-logs">
                    <div class="chat-msg user">
                        <div class="d-flex align-items-center">
                            <span class="msg-avatar">
                                <img  src="template/template/vertical/../../images/avatar/2.jpg" class="avatar avatar-lg" alt="">
                            </span>
                            <div class="mx-10">
                    ...
                    <div class="chat-msg self">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <span class="msg-avatar">
                                <img  src="template/template/vertical/../../images/avatar/3.jpg" class="avatar avatar-lg" alt="">
                            </span>
                        </div>
                        <div class="cm-msg-text">
